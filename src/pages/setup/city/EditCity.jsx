...
function EditCity() {
    ...
    useEffect(() => {
        http.get(`city/${id}/edit`).then(res=> {
    ...
    const submitFormData = (e) => {
        ...
        formData.append('city_name', form_data.city_name);

        http.post(`city/update/${id}`, formData).then(res => {
            if (res.data.status === 200) {
                Swal.fire({
                    position: 'top-center',
                    icon: 'success',
  ...
  return (
      <div className="page-content">
            ...
            <div className="custom-card patients-head ">
                <h5 className="fw-normal custom_py-3 px-2  text-start mb-2 card-title">Edit City
                      ...
                      <div className="card-body">
                          ...
                          <form onSubmit={submitFormData}>
                              ...
                              <div className="mb-3">
                                  ...
                                  <input type="text" name="city_name" className="form-control form-control-sm" value={form_data.city_name} onChange={handleInput} />
