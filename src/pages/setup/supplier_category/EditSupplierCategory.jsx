...
function EditSupplierCategory() {
    ...
    useEffect(() => {
        http.get(`supplier-category/${id}/edit`).then(res=> {
    ...
    const submitFormData = (e) => {
        ...
        http.post(`supplier-category/update/${id}`, formData).then(res => {
            if (res.data.status === 200) {
                Swal.fire({
                    position: 'top-center',
                    icon: 'success',
                  ...
                  <div className="card">
                      <div className="card-body">
                          ...
                          <form onSubmit={submitFormData}>
                              ...
                              <div className="mb-3">
                                  <label htmlFor="supplier_category_name" className="form-label">Designation</label>
