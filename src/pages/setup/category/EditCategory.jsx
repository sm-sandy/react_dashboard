  ...
  return (
      <div className="page-content">
            ...
            <div className="custom-card patients-head ">
                <h5 className="fw-normal custom_py-3 px-2  text-start mb-2 card-title">Edit Category
                          ...
                          <form onSubmit={submitFormData}>
                              ...
                              <div className="mb-3">
                                  ...
                                  <input type="file" name="picture" className="form-control form-control-sm" onChange={handleimageUrl}
                                    ...
                                    {imageUrl == null ? <img src={`${global.img_url}/files/category/${form_data.photo}`} width="100" className="imageUrlPreview" alt="preview image" /> :
