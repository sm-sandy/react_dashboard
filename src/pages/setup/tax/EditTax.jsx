...
function EditTax() {
    ...
    const submitFormData = (e) => {
        ...
        http.post(`tax/update/${id}`, formData).then(res => {
            if (res.data.status === 200) {
                Swal.fire({
                    position: 'top-center',
                    icon: 'success',
                  ...
                  <div className="card">
                      <div className="card-body">
                          ...
                          <form onSubmit={submitFormData}>
                              ...
                              <div className="mb-3">
                                  <label htmlFor="tax_name" className="form-label">Vat</label>
                                  <input type="text" name="tax_name" className="form-control form-control-sm" value={form_data.tax_name} onChange={handleInput} />
