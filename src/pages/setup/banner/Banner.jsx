...
function Banner() {
    ...
    const columns = [
        ...
        {
            title: "Photo", field: `photo`, render: (row) =><>{row.photo !== null ? <img src={`${global.img_url}/files/banner/${row.photo}`} width="70" alt="No Image" /> : <img src={`${global.img_url}/files/no_images.png`} width="70px" alt="No Image" />}</>
